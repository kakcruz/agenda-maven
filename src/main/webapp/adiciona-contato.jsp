			...
			<div class="card-body">
				<form action="cadastra-usuario" id="form-produto">
					...
					<div class="form-row">
						...
						<div class="form-group col-md-3">
							<label for="email">CEP</label> <input type="text"
								value="${param.cep}" class="form-control" id="cep" name="email"
								placeholder="Digite seu CEP" data-mask="99999-999">
						</div>
							...
							<div class="input-group mb-3">
								...
								<select class="custom-select" id="inputGroupSelect01">
									...
									<option value="naofalar">Não Informar!</option>
								</select>
							</div>
							
							<div class="form-group col-md-6">
							<button class="btn btn-success" id="btnSalvar" type="submit">Salvar</button>
							<button class="btn btn-primary" href="index.html" type="submit">Voltar</button>
						</div>
